(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.htmlToText = {}));
	...
	util$1.clamp = clamp;
	util$1.escapeWhitespace = escapeWhitespace;
	...
	function parse$1(parser, tokens, options, formatToken = JSON.stringify) {
	...
	core.any = any;
	core.chain = chain;
	core.chainReduce = chainReduce;
	core.choice = choice;
	core.condition = condition;
	core.decide = decide;
	core.discard = skip;
	core.eitherOr = otherwise;
	core.emit = emit;
	core.end = end;
	core.eof = end;
	core.error = error;
	...
	core.flatten1 = flatten1;
	core.left = left;
	core.leftAssoc1 = leftAssoc1;
	core.leftAssoc2 = leftAssoc2;
	core.longest = longest;
	core.lookAhead = ahead;
	core.make = make;
	core.many = many;
	core.many1 = many1;
	core.map = map;
	...
	core.option = option;
	core.or = choice;
	core.otherwise = otherwise;
	core.parse = parse$1;
	core.parserPosition = parserPosition;
	core.peek = peek;
	core.recursive = recursive;
	core.reduceLeft = reduceLeft;
	core.reduceRight = reduceRight;
	core.remainingTokensNumber = remainingTokensNumber;
	core.right = right;
	core.rightAssoc1 = rightAssoc1;
	core.rightAssoc2 = rightAssoc2;
	core.satisfy = satisfy;
	core.sepBy = sepBy;
	core.sepBy1 = sepBy1;
	core.skip = skip;
	core.some = many1;
	core.start = start;
	core.takeUntil = takeUntil;
	core.takeUntilP = takeUntilP;
	core.takeWhile = takeWhile;
	core.takeWhileP = takeWhileP;
	core.token = token;
	core.tryParse = tryParse;
	...
	var p__namespace = /*#__PURE__*/_interopNamespace$2(p);
	...
	Object.defineProperty(hp2Builder$1, '__esModule', { value: true });
	...
	hp2Builder$1.hp2Builder = hp2Builder;
	...
	Object.defineProperty(htmlToText, '__esModule', { value: true });

	var pluginHtmlparser2 = hp2Builder$1;
	var htmlparser2 = lib$3;
	var selderee = selderee$2;
	var merge = cjs;
	var domSerializer = lib$1;
	...
	var compile_1 = htmlToText.compile = compile;
	var convert_1 = htmlToText.convert = convert;
	var htmlToText_1 = htmlToText.htmlToText = convert;

	exports.compile = compile_1;
	exports.convert = convert_1;
	exports.default = htmlToText;
	exports.htmlToText = htmlToText_1;
